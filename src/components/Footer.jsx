  ...
  return (
    <footer className="text-center text-sm text-gray-600 py-6 bg-white border-t mt-12">
      <div className="flex justify-center space-x-6 mb-2">
        ...
        <a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600"><Mail size={20} /></a>
      </div>
